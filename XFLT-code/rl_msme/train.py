...
from model.dataloader import get_dataset_loaders
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', default='/scratch/userid/checkpoints/', help='where to save the logs and checkpoints')
